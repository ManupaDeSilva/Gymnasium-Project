...
const Homepage2 = () => {
  ...
  const onHomeButton12ContainerClick = useCallback(() => {
    navigate("/equipmentbookingpage");
  }, [navigate]);

  const onOutdoorFacilitiesTextClick = useCallback(() => {
    navigate("/outdoorfacilities");
  }, [navigate]);

  const onIndoorFacilitiesTextClick = useCallback(() => {
    navigate("/indoorfacilities");
  }, [navigate]);

  const onHomeButton22ContainerClick = useCallback(() => {
    navigate("/eventshedule");
  }, [navigate]);

  const onSelectSportContainerClick = useCallback(() => {
    navigate("/sports");
  }, [navigate]);
  ...
  return (
    <div className="homepage">
      ...
      <div className="homebutton1-2" onClick={onHomeButton12ContainerClick}>
        <img
      ...
      <div className="homebutton3-2">
        ...
        <div
          ...
          onClick={onOutdoorFacilitiesTextClick}
        >
          Outdoor Facilities
        </div>
        <div
          className="indoor-facilities"
          onClick={onIndoorFacilitiesTextClick}
        >
          Indoor Facilities
        </div>
        <b className="schedule">FACILITIES</b>
      </div>
      <div className="homebutton2-2" onClick={onHomeButton22ContainerClick}>
        <img
          className="bookinghomepageimg-2-icon"
          alt=""
          src="/bookinghomepageimg-2@2x.png"
      ...
      <div className="selectsport" onClick={onSelectSportContainerClick}>
        <img
